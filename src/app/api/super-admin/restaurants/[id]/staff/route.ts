...
export async function POST(
  ...
  try {
    ...
    const validRoles = ["waiter", "captain", "kitchen", "cashier", "manager", "admin", "owner", "staff"];
    ...
    logActivity({
      ...
      details: `Created staff member "${name}" (${role}) for restaurant "${restaurant.name}"`,
    });
